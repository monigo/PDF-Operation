...
<div class="container" style="padding-top:200px;min-height:738px;text-size:36px;">
    ...
    <form class="form-signin" action="handle_extract_text" method="POST" enctype="multipart/form-data" >        
      ...
      <br>
      <div class="form-group">
      <button style="font-size: 36px;" class="btn btn-lg btn-primary btn-block" type="submit" >EXTRACT</button> 
      </div>
